[
    { # evd3dev browser extension (it works nice only with python though)
    name = "ev3dev-browser";
    publisher = "ev3dev";
    version = "1.0.4";
    sha256 = "d951a7dde2eb891efb495d4082cbd70bc0104995026ff1ed6cb8614baa37d333";
    }
    { # nice light theme
    ...
    publisher = "iCrawl";
    version = "3.6.0";
    sha256 = "e41c6782c9b7fad62f11ede08f2f596abd61f31ab22422d056f1bc931478bb55";
    }
    { # golang extension
    name = "Go";
    publisher = "ms-vscode";
